...
void CTextProgressCtrl::OnPaint()
{
	...
	{
		CString sPerc;
		sPerc.Format(_T("%d%%"), (int)((dFraction * 100.0) + 0.5));
		str += sPerc;
	}
...
void CTextProgressCtrl::SetDrawEdge(BOOL bDraw)
{
	m_bHasEdge = bDraw;
}

BOOL CTextProgressCtrl::GetDrawEdge() const
{
	return m_bHasEdge;
}

DWORD CTextProgressCtrl::GetTextAlignment() const
{
